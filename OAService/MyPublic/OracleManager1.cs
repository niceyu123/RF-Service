...
{
    public class OracleManager1

    {
        static private OracleConnection conn;
        private OracleManager1()
        {
            string connStr = "User ID=ravo1;Password=loginserver;Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.10.6)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = syravoerp)))";
        ...
        /// 单例模式
        /// </summary>
        static public OracleManager1 Instance = new OracleManager1();
