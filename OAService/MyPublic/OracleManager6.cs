...
{
    public class OracleManager6



    {
        static private OracleConnection conn;
        private OracleManager6()
        {
            //未更改
            string connStr = "User ID=ravo6;Password=loginserver;Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 172.16.11.113)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = ravoerp)))";
        ...
        /// 单例模式
        /// </summary>
        static public OracleManager6 Instance = new OracleManager6();
