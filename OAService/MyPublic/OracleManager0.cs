...
{
    public class OracleManager0



    {
        static private OracleConnection conn;
        private OracleManager0()
        {
            //未更改
            string connStr = "User ID=ravo0;Password=loginserver;Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 172.16.11.113)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = ravoerp)))";
        ...
        /// 单例模式
        /// </summary>
        static public OracleManager0 Instance = new OracleManager0();
